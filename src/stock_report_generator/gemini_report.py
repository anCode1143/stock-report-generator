    ...
    def __init__(self, api_key=None):
        ...
        if api_key:
            ...
            if api_key:
                ...
                raise ValueError("No API key provided. Please set GOOGLE_AI_API_KEY environment variable or pass api_key parameter.")
    ...
    def _load_environment(self):
        ...
        for dotenv_path in dotenv_locations:
            if os.path.exists(dotenv_path):
                ...
                load_dotenv(dotenv_path=dotenv_path, override=True)  # override=True ensures it reloads
                env_loaded = True
                break
...
- Average Volume: {df['Volume'].tail(10).mean():,.0f}
    ...
    def print_report(self, ticker):
        ...
        if isinstance(result, tuple) and len(result) == 2:
            ...
            print(f"💾 Full report saved in reports/ directory")
            print(f"{'='*80}")
